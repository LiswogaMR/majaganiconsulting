<?php
    ...
    function get_records($dataSearch, $columnName, $orderDirection, $dataLength, $dataStart,$conn, $limit = false){
        ...
        $user_sql_resultset = "SELECT * FROM majaganiconsulting.job_postings WHERE job_postings.status = 'Open' ";
                                
        if($dataSearch != ''){
            $user_sql_resultset .= "OR job_postings.job_title LIKE '%".$dataSearch."%' ";
