...
<html>
<head>
	<title>MAJAGANI CONSULTING (PTY) LTD - Change Password page</title>
  	<meta charset="utf-8">
...
<body class="container">
	...
	<header class="container-fluid">
		<div class="row">
			<div>
				<div class="center">
					<!-- <img src="assets/img/logo.png" style="width:250px; height:75px"> -->
				</div>
				<div class="center">
					<p style="font-size: 18px; font-weight: bold; padding: 15px; color: #313541;">MAJAGANI CONSULTING (PTY) LTD</p>
				</div>
			</table>
		</div>
